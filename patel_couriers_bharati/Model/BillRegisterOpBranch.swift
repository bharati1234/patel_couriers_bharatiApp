//
//  BillRegisterOpBranch.swift
//  patel_couriers_bharati
//
//  Created by WindHans on 31/07/23.
//

import Foundation
class BillRegisterOpBranch {
    ...
    init(json: JSON) {
        ...
        self.column1 = json["isCheck"].stringValue
        self.stateName = json["column1"].stringValue
        self.opBranchId = json["stateName"].stringValue
